...
public class EditorStepdefinitions { //# 14 ocak stabil
    ...
    public void create_tusuna_basar() {
        editorPage.craete.click();
    }
    @When("kullanici {string} ile arama yapar")
    public void kullanici_ile_arama_yapar(String firstname) {
        editorPage.search.sendKeys(firstname+ Keys.ENTER);
    }
    ...
    public void kullaniciAnasayfayaGider(String editorUrl) {
    }
}
